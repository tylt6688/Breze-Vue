                ...
                <div class="ef-tooltar">
                    ...
                    <div style="float: right;margin-right: 5px">
                        ...
                        <el-button type="primary" plain round @click="dataReloadB" icon="el-icon-refresh" size="mini">
                            切换流程B</el-button>
                        <el-button type="primary" plain round @click="dataReloadC" icon="el-icon-refresh" size="mini">
                            切换流程C</el-button>
                        <el-button type="primary" plain round @click="dataReloadD" icon="el-icon-refresh" size="mini">
                            自定义样式</el-button>
                        <el-button type="primary" plain round @click="dataReloadE" icon="el-icon-refresh" size="mini">
                            力导图</el-button>
...
<script>
    ...
    import {
        easyFlowMixin
    } from '@/components/flow-chart/mixins'
    import flowNode from '@/components/flow-chart/node'
    import nodeMenu from '@/components/flow-chart/node_menu'
    import FlowInfo from '@/components/flow-chart/info'
    import FlowHelp from '@/components/flow-chart/help'
