<template>
	<div class="page">
		...
		<el-dialog title="新增目录" :visible.sync="dialogDirVisible" width="600px" :before-close="handleClose">
			<el-form :model="editForm" :rules="editDirFormRules" ref="editForm" label-width="100px"
				class="demo-editForm">
				...
				<el-form-item label="图标" prop="icon" label-width="100px">
					<e-icon-picker v-model="editForm.icon" placement="bottom" width="400" />
				</el-form-item>
		...
		<el-dialog title="新增编辑" :visible.sync="dialogVisible" width="600px" :before-close="handleClose">
			<el-form :model="editForm" :rules="editFormRules" ref="editForm" label-width="100px" class="demo-editForm">
				...
				<el-form-item label="图标" prop="icon" label-width="100px">
					<e-icon-picker v-model="editForm.icon" placement="bottom" width="400px" />
				</el-form-item>
			...
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if (valid) {
						...
						this.$axios.post('/sys/menu/' + (this.editForm.id ? 'update' : 'insert'), this.editForm)
							.then(res => {
								this.$message({
									showClose: true,
									duration: 2000,
