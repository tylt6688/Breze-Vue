<template>
  <div class="page">
    ...
    >
      <el-form :model="editForm" :rules="editFormRules" ref="editForm">
        <el-form-item label="登录用户名" prop="username" label-width="100px">
          ...
          <el-alert
            title="用户名可为统一工号，新增用户初始密码为:123456"
            :closable="false"
            type="info"
    ...
    <el-dialog
      ...
      width="600px"
      :before-close="morehandClose"
    >
      <el-button type="primary" round @click="exportModelExcel"
        >下载 Excel 导入模板</el-button
      >
    ...
    <el-dialog
      title="批量分配角色"
      :visible.sync="roleMoreDialogFormVisible"
      width="600px"
    >
      <el-form :model="roleForm">
        <el-tree
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitMoreRoleHandle('roleForm')"
          >确 定</el-button
        >
