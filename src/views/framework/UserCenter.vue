  ...
  <div class="page">
      ...
      <el-tab-pane label="用户信息">
        ...
        >
          ...
          <template slot="extra" :slot-scope="userInfo">
            <el-button
              @click="editUserInfo(userInfo.id)"
              type="primary"
              size="small"
              >编辑资料</el-button
            >
        ...
        >
          <el-row>
            <el-form-item label="建议反馈" prop="suggest">
              <el-input
                v-model="suggformData.suggest"
                type="textarea"
                placeholder="请输入您对此平台的建议反馈"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitUserInfoForm('editForm')"
          >确 定</el-button
        >
